...
export function LiquidEther({
  ...
  useEffect(() => {
    ...
    const color_frag = `
      ...
      void main(){
        vec2 vel = texture2D(velocity, uv).xy;
        // Boost velocity mapping slightly to make fluid more prominent
    ...
    class WebGLManager implements LiquidEtherWebGL {
      ...
      init() { if (Common.renderer) { this.props.$wrapper.prepend(Common.renderer.domElement); this.output = new Output(this.props); } }
